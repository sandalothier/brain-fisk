...
@RestController
@RequestMapping("/api/fisk-kafka")
public class FiskKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FiskKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FiskKafkaResource(KafkaProperties kafkaProperties) {
